...
void AMyActorBox::GenerateBoxMesh() {
...
void AMyActorBox::CreateBoxMesh(FVector BoxRadius, TArray < FVector >& Vertices, TArray < int32 >
...
void AMyActorBox::PostActorCreated()
{
	Super::PostActorCreated();
	GenerateBoxMesh();
}
void AMyActorBox::PostLoad()
{
	Super::PostLoad();
	GenerateBoxMesh();
}
